<?php
// untuk mendapatkan shoes-id
if(isset($_GET['shoes_id'])) {
  // untuk mengecek apakah shoes_id tidak kosong dan bertipe angka
     	...
     	<h2><?php echo $shoes_obj->shoes_name(); ?></h2>
            ...
            <div class="content_half float_l">
        	 ...
        	 <a title="Product Name"  rel='lightbox[roadtrip]' href='<?php echo $display_image_url . $shoes_obj->maskot_image($shoes_obj->shoes_id()); ?>' >
              ...
              <div class="img_box">
                  <?php
                      $shoes_img = $shoes_obj->get_images($shoes_obj->shoes_id());

                      if(!$utility_obj->isarrayempty($shoes_img)) {
                  ?>
            ...
            <div class="content_half float_r">
                ...
                <div class="cleaner">
                  ...
                  <div class="desc_box">
                  	  ...
                  	  <h5><?php echo $shoes_obj->description(); ?></h5>
          ...
          <?php foreach ($same_brand as $rowsame) {  ?>
        	<div class="product_box">
            	...
            	<a href="#"><img src="<?php echo $display_image_url . $shoes_obj->maskot_image($rowsame['shoes_id'])?>" alt="" /></a>
